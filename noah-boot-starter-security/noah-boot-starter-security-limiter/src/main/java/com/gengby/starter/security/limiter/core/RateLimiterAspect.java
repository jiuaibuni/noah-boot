...
public class RateLimiterAspect {
     ...
     * 单个限流注解切点
     */
    @Pointcut("@annotation(com.gengby.starter.security.limiter.annotation.RateLimiter)")
     ...
     * 多个限流注解切点
     */
    @Pointcut("@annotation(com.gengby.starter.security.limiter.annotation.RateLimiters)")
